...
import LoginData from '../loginData.json'
  ...
  class client{
    ...
    constructor(page){
        ...
        this.clickClient = page.getByRole('button', { name: 'Clients' })
        this.ClickClientname= page.getByRole('button', { name: 'kavita' })
        this.clickInternal=page.getByRole('button', { name: 'Internal Projects' })
        this.searchButton =page.getByRole('textbox', { name: 'Search Something' })
        this.fillData=page.getByRole('textbox', { name: 'Search Something' })
        this.clickProjectID=page.getByRole('button', { name: 'prer_11113' })
        this.clickFormId=page.getByRole('button', { name: 'FID1191' })
        this.proceedbtn = page.getByRole('button', { name: 'Save and Proceed' })
